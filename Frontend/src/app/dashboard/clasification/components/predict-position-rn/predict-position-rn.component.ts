...
@Component({
  selector: 'app-predict-position-rn',
  templateUrl: './predict-position-rn.component.html',
  styleUrl: './predict-position-rn.component.css'
})
export class PredictPositionRNComponent {
