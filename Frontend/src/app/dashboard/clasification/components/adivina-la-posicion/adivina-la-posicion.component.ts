...
@Component({
  selector: 'app-adivina-la-posicion',
  templateUrl: './adivina-la-posicion.component.html',
  styleUrls: ['./adivina-la-posicion.component.css']
})
export class AdivinaLaPosicionComponent implements OnInit {
  ...
  sendForm() {
    ...
    this.jugadoresService.guessPosition(playerData)
      .subscribe(
        response => {
