...
@Component({
  selector: 'app-expected-assist',
  templateUrl: './expected-assist.component.html',
  styleUrl: './expected-assist.component.css'
})
export class ExpectedAssistComponent {
  ...
  sendForm() {
    ...
    this.jugadoresService.expectedAssist(playerData)
      .subscribe(
        response => {
          this.xAssist = response['expectedAssists'];
          this.mostrarxAssists = this.xAssist.toString().substring(0, 5);
        },
        error => {
