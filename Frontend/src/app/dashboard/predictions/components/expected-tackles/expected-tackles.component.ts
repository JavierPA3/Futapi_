...
import { Comp, Player } from '../../../interfaces/jugador';
import { JugadoresService } from '../../../services/jugadores.service';
import { Field, FieldType } from '../../../interfaces/form.interface';

@Component({
  selector: 'app-expected-tackles',
  templateUrl: './expected-tackles.component.html',
  styleUrl: './expected-tackles.component.css'
})
export class ExpectedTacklesComponent {
  ...
  sendForm() {
    ...
    this.jugadoresService.expectedTackles(playerData)
      .subscribe(
        response => {
          this.tackles = response['expectedTackles'];
          this.mostrarTackles = this.tackles.toString().substring(0, 5);          
