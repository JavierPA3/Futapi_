...
@Component({
  selector: 'app-expected-goals',
  templateUrl: './expected-goals.component.html',
  styleUrl: './expected-goals.component.css'
})
export class ExpectedGoalsComponent {
  ...
  sendForm() {
    ...
    this.jugadoresService.expectedGoals(playerData)
      .subscribe(
        response => {
          this.xGoals = response['expectedGoals'];
          this.mostrarXGoals = this.xGoals.toString().substring(0, 5);
          console.log('Goles esperados:', this.xGoals);
